...
<head>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // 激活导航位置
            setSidebarActive("permission-manager");
                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建" onclick="location.href='../pages/permission-add.jsp'"><i class="fa fa-file-o"></i> 新建</button>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${permissions}" var="permission" varStatus="s">

                                <tr>
                                    <td><input   name="Ids"  id="${s.index}" type="checkbox" value="${permission.id}" ></td>
                                    <td>${permission.id}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs" onclick='location.href="/permission/deletePermission.do?id=${permission.id}"'>详情</button>
