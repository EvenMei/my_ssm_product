                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${orders}" var="order" varStatus="s">
                                ...
                                <tr>
                                    <td><input   name="Ids"  id="${s.index}" type="checkbox" value="${order.id}" ></td>
                                    <td>${order.id}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs" onclick='location.href="/orders/showDetail.do?id=${order.id}"'>详情</button>
