...
<head>
    ...
    <script>
        ...
        function alterPage(pageNum , pageSize){
            var pageArr  = new Array();
            pageArr.push(pageNum);
            pageArr.push(pageSize);
            $.post("/product/findAll.do", JSON.stringify(pageArr),
                function(data){
                alert(data);}
                );
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${pageInfo.list}" var="product" varStatus="s">
                                ...
                                <tr>
                                    <td><input   name="Ids"  id="${s.index}" type="checkbox" value="${product.id}" ></td>
                                    <td>${product.id}</td>
